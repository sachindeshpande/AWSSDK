 ...
 * (/Users/sachindeshpande/.aws/credentials) where the sample code will load the credentials from.
 * <p>
...
public class CloudFormationSample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /*
         * The ProfileCredentialsProvider will return your [awstest1]
         * credential profile by reading from the credentials file located at
         * (/Users/sachindeshpande/.aws/credentials).
         */
        AWSCredentials credentials = null;
        try {
            credentials = new ProfileCredentialsProvider("awstest1").getCredentials();
        } catch (Exception e) {
            throw new AmazonClientException(
                    "Cannot load the credentials from the credential profiles file. " +
                    "Please make sure that your credentials file is at the correct " +
                    "location (/Users/sachindeshpande/.aws/credentials), and is in valid format.",
                    e);
        }
